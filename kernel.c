...
void entry(unsigned long magic, unsigned long addr) {
    ...
    if (CHECK_FLAG(mbi->flags, 3)) {
        ...
        // get address for beginning of filesystem and store in global
        file_sys_init = mod->mod_start;
    ...
    init_IDT();
    /*initialize the PIC here first */
    i8259_init();
    /*initialize the keyboard */
	init_board();
	/*initialize rtc*/
	enable_rtc();
    /*initialize the PIT to 40Hz*/
    init_PIT(40);
    /* initalize the paging*/
    init_paging();
    /*initialize filesystem*/
    file_init_mod(file_sys_init);
    /*initialize mult terminals and shell*/
    terminal_init();
    ...
    //launch shell on terminal0, will reenable interrupts 
