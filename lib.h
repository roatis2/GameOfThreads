...
#define ROW_START      0	//starting x_pos of row
#define COL_START      0	//first col, min col index
...
//set screen position to desired coordinates
void set_screen_pos(uint8_t x, uint8_t y, uint8_t term);

//Handle backspace 
void Backspace(uint8_t term);

//Handle Enter, needed to use screen position from lib.c 
void Enter(uint8_t term);

//position cursor
void move_cursor(uint8_t term);

//scroll screen when full
